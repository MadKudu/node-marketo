...
List.prototype = {
  ...
  addLeadsToList: function (listId, input) {
    ...
    return this._connection.post(path, { input: input });
  },
  ...
  addEmailsToList: function (emails, listId, options) {
    ...
    return this._marketo.lead
      .createOrUpdate(emails, { lookupField: 'email' })
      .then(
