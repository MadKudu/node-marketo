...
BulkActivityExtract.prototype = {
  create: function (fields, filter, options) {
    ...
    var path = '/../bulk' + util.createPath('activities', 'export', 'create.json');
  ...
  enqueue: function (exportId, options) {
    var path = '/../bulk' + util.createPath('activities', 'export', exportId, 'enqueue.json');
    options = _.extend({}, options, {
      _method: 'POST'
    });
  ...
  status: function (exportId, options) {
    var path = '/../bulk' + util.createPath('activities', 'export', exportId, 'status.json');
    options = _.extend({}, options, {
      _method: 'GET'
    });
  ...
  cancel: function (exportId, options) {
    var path = '/../bulk' + util.createPath('activities', 'export', exportId, 'cancel.json');
    options = _.extend({}, options, {
      _method: 'POST'
    });
    return this._connection.post(path, { data: options });
  ...
  file: function (exportId, options) {
    var path = '/../bulk' + util.createPath('activities', 'export', exportId, 'file.json');
    options = _.extend({}, options, {
      _method: 'GET'
    });
    return this._connection.get(path, { data: options });
